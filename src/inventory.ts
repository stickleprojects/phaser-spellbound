...
export class ItemAlreadyInInventoryError extends InventoryItemError {
  constructor(inventory: Inventory, item: IInventoryItem) {
    super(
      inventory,
      item,
      new TemplateString("Item ${0} already in the inventory", item.id)
    );
  }
}
...
export class ItemTooHeavyError extends InventoryItemError {
  constructor(inventory: Inventory, item: IInventoryItem) {
    super(
      inventory,
      item,
      new TemplateString("Item ${0} is too heavy", item.id)
    );
  }
}
export class TooManyItemsError extends InventoryItemError {
  constructor(inventory: Inventory, item: IInventoryItem) {
    super(
      inventory,
      item,
      new TemplateString("Not enough room for ${0}", item.id)
    );
  }
}
export class ItemNotInInventoryError extends InventoryItemError {
  constructor(inventory: Inventory, item: IInventoryItem) {
    super(
      inventory,
      item,
      new TemplateString("${0} is not in the inventory", item.id)
    );
  }
}
...
export class Inventory {
  ...
  public FindItem(
    predicate: (a: IInventoryItem) => boolean
