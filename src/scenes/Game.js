...
class Game extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet("world-1-sheet", "assets/tilesets/groundtiles.png", {
      frameWidth: 32,
      frameHeight: 32,
      margin: 1,
      spacing: 2,
    ...
    this.load.spritesheet("coin-sheet", "assets/tiles/coins.png", {
      frameWidth: 32,
      frameHeight: 32,
    });

    this.load.spritesheet("key-sheet", "assets/tiles/key.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
  }
  ...
  addMap() {
    ...
    this.finishGroup = this.physics.add.group({
      immovable: true,
      allowGravity: false,
    });
  ...
  addHero() {
    ...
    const keyCollider = this.physics.add.overlap(
      this.hero,
      this.keyGroup,
      (a, b) => {
        b.destroy();
    ...
    const finishCollider = this.physics.add.overlap(
      this.hero,
      this.finishGroup,
      (a, b) => {
        b.destroy();
  ...
  update() {
    ...
    if (
      this.hero.isDead() &&
      this.hero.getBounds().bottom > cameraBottom + 100
    ) {
      this.hero.destroy();
      this.addHero();
    }
